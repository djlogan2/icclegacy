    ...
    const data = level1(
      ...
      "this is 10 text" +
        level1(
          11,
          "mi2",
          "this is 11 text" + level1(12, "mi3", "this is 12 text")
        )
    );
    const legacy = new Legacy({
      preprocessor: (packets) => {
        ...
        chai.assert.equal(
          packets.level1Packets[0],
          "10 * mi1\r\nthis is 10 text"
        );
        chai.assert.equal(
          packets.level1Packets[1],
          "11 * mi2\r\nthis is 11 text"
        );
        chai.assert.equal(
          packets.level1Packets[2],
          "12 * mi3\r\nthis is 12 text"
        );
        done();
        return true;
    ...
    const data = level1(
      ...
      "level 2 test" +
        level2(
          ...
          "p1",
          B("p2 with spaces"),
          CB("{p3 with brackets and spaces}")
        )
    );
    const legacy = new Legacy({
      preprocessor: (packets) => {
        ...
        chai.assert.equal(
          packets.level2Packets[0].packet,
          "100 p1 {p2 with spaces} {{p3 with brackets and spaces}}"
        );
        done();
        return true;
      },
        ...
        level1(
          ...
          "This is level1 command 12 text" +
            level2(
              ...
              "l2_100",
              B("l2_100 with space"),
              CB("l2_100 with {brackets} and spaces")
            ) +
            level2(
              101,
              "l2_101",
              B("l2_101 with space"),
              CB("l2_101 with {brackets} and spaces")
            )
        ) +
          level2(
            102,
            "l2_102",
            B("l2_102 with space"),
            CB("l2_102 with {brackets} and spaces")
          ) +
          level2(
            103,
            "l2_103",
            B("l2_103 with space"),
            CB("l2_103 with {brackets} and spaces")
          )
      ) +
        level2(
          104,
          "l2_104",
          B("l2_104 with space"),
          CB("l2_104 with {brackets} and spaces")
        ) +
        level2(
          105,
          "l2_105",
          B("l2_105 with space"),
          CB("l2_105 with {brackets} and spaces")
        )
    );
    const legacy = new Legacy({
      preprocessor: (packets) => {
        ...
        chai.assert.equal(
          packets.level2Packets[0].packet,
          "100 l2_100 {l2_100 with space} {l2_100 with {brackets} and spaces}"
        );
        ...
        chai.assert.equal(
          packets.level2Packets[1].packet,
          "101 l2_101 {l2_101 with space} {l2_101 with {brackets} and spaces}"
        );
        ...
        chai.assert.equal(
          packets.level2Packets[2].packet,
          "102 l2_102 {l2_102 with space} {l2_102 with {brackets} and spaces}"
        );
        ...
        chai.assert.equal(
          packets.level2Packets[3].packet,
          "103 l2_103 {l2_103 with space} {l2_103 with {brackets} and spaces}"
        );
        ...
        chai.assert.equal(
          packets.level2Packets[4].packet,
          "104 l2_104 {l2_104 with space} {l2_104 with {brackets} and spaces}"
        );
        ...
        chai.assert.equal(
          packets.level2Packets[5].packet,
          "105 l2_105 {l2_105 with space} {l2_105 with {brackets} and spaces}"
        );
        done();
        return true;
      },
